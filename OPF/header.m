...
[num_bus,txt_bus,raw_bus] = xlsread('ieee37_EXP_Y.CSV');
...
for iter = 1:3
    ...
    [Voltage_profile, phasors] = ieee37_iter(loads, Zbus, Cbus);
    % [Voltage_profile, phasors] = ieee37_hybrid2(loads, Zbus, Cbus);
    % update the loads
end
